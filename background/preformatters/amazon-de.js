var BINPreformatter = ( function () {
	...
	function preformatData(metaData, parser) {
		...
		metaData["citation_authors"] = BINResources.htmlDecode(metaData["citation_authors"]).replace(/[\;\s\u200F\u200E]*(?:Entdecken|Suchergebnisse|Erfahren|検索結果|著者セントラルはこちら|Visit|Search|Learn|Visita|Resultados|Consulter|résultats|Infos)[\s\u200F\u200E][^;]*/gi,"");
    ...
    dataPart = data.match(/ISBN\-13[^;]*(?:;|$)/i)
		...
		metaData["citation_database"] = "Amazon.de Webstore";
	}
