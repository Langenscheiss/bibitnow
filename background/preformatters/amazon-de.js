var BINPreformatter = ( function () {
	...
	function preformatData(metaData, parser) {
		...
		metaData["citation_authors"] = BINResources.htmlDecode(metaData["citation_authors"]).replace(/[\ ;]*(?:Entdecken|Suchergebnisse|Erfahren|検索結果|著者セントラルはこちら|Visit|Search|Learn|Visita|Resultados|Consulter|résultats|Infos)\ [^;]*/gi,"");
