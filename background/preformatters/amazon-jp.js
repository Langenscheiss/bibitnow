var BINPreformatter = ( function () {
	...
	function preformatData(metaData, parser) {
		...
		metaData["citation_authors"] = metaData["citation_authors"].replace(/のAmazon著者ページを見る/gi,"").replace(/[\ ;]*(?:Entdecken|Suchergebnisse|Erfahren|検索結果|著者セントラルはこちら|Visit|Search|Learn|Visita|Resultados|Consulter|résultats|Infos)\ [^;]*/gi,"");
