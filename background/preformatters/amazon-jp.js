var BINPreformatter = ( function () {
	...
	function preformatData(metaData, parser) {
		...
		metaData["citation_authors"] = metaData["citation_authors"].replace(/のAmazon著者ページを見る/gi,"").replace(/[\s\;\u200F\u200E]*(?:Entdecken|Suchergebnisse|Erfahren|検索結果|著者セントラルはこちら|Visit|Search|Learn|Visita|Resultados|Consulter|résultats|Infos)[\s\u200F\u200E][^;]*/gi,"");
		...
		metaData["citation_database"] = "Amazon.jp Webstore";
	}
