var BINPreformatter = ( function () {
	...
	function preformatData(metaData, parser) {
		...
		let dataPart = data.replace(/\([^\(\)]*\)[\ ]*$/,"").match(/Uitgever[^;\(]*/i);
		if (dataPart != null && dataPart.length > 0) metaData["citation_publisher"] = dataPart[0].replace(/^Uitgever[\s ]*[:]*/i,"").trim();
		...
		metaData["citation_database"] = "Amazon.nl Webstore";
	}
