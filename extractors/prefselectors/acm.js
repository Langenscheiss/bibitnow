var BINPrefselector = ( function () {
	...
	var prefselectorMsg = {
		citation_title: [ ['h1.citation__title','innerText'] ],
		citation_publisher: [ ['p.publisher__name','innerText'] ],
		citation_author: [ ['div.pill-all-authors a.author-name','title'] , ['div.citation div.author-data span.loa__author-name','innerText'] , ['meta[name="citation_authors"]','content']],
		...
		citation_abstract: [ ['div.article__section.article__abstract','innerText',true,20000] , ['meta[name="dc.Description"]','content',true,20000], ['div#abstract','innerText',true,20000] ],
