var BINPrefselector = ( function () {
	...
	var prefselectorMsg = {
		citation_author: [ ['div.pb-sig-line > span[itemprop="author"] span[itemprop="name"]', 'innerText'] , ['div.bottomizer > span[itemprop="author"] span[itemprop="name"]', 'innerText'] , ['a.pg-byline--author','innerText']], /*added 'div.pb-sig-line >' and 'div.bottomizer >' to avoid author doubling due to mobile version. One may probably add the mobile version content as an additional query to make this mobile ready, but BIN is currently not being developed with mobile support in mind*/
