var BINPrefselector = ( function () {
	...
	var prefselectorMsg = { 
		citation_publisher: [ ['meta[name="ST.publisher"]','content'] , ['div#metadata-info-tab-contents div.publication-info a.publisher-link','innerText'] ],
		...
		citation_authors: [ ['div#metadata-info-tab-contents div.contrib span.name','innerText'], ['div.contrib','innerText'] ],
		...
		citation_download: [ ['li.cite-this-item-button a','href'] , ['a.button.cite-this-item','href'] , ['div#metadata-info-tab-contents div.cite-this-item-column button[data-qa="cite-this-item" i]','data-cite-button-doi'] ],
